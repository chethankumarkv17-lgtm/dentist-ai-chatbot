...
const liquidbuttonVariants = cva(
  "group relative inline-flex items-center justify-center cursor-pointer gap-2.5 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 select-none overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-white/85 hover:bg-white text-slate-800 border border-slate-200/90 hover:border-slate-300/90 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.9),0_2px_8px_-2px_rgba(15,23,42,0.06)] hover:shadow-[inset_0_1px_1px_0_rgba(255,255,255,1),0_8px_20px_-4px_rgba(15,23,42,0.1)] hover:-translate-y-0.5 active:translate-y-0 backdrop-blur-md",
        primary:
          "bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-600 hover:from-blue-700 hover:via-blue-700 hover:to-indigo-700 text-white border border-blue-400/30 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.35),0_4px_14px_0_rgba(37,99,235,0.25)] hover:shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.45),0_8px_24px_0_rgba(37,99,235,0.35)] hover:-translate-y-0.5 active:translate-y-0",
        destructive:
          "bg-red-600 text-white hover:bg-red-700 border border-red-400/30 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.35),0_4px_14px_0_rgba(239,68,68,0.25)]",
        outline:
          "bg-transparent hover:bg-slate-50/80 text-slate-700 border border-slate-200/90 hover:border-slate-300 backdrop-blur-xs",
        secondary:
          "bg-slate-100/90 hover:bg-slate-200/80 text-slate-800 border border-slate-200/60 backdrop-blur-sm",
      ...
      size: {
        ...
        xl: "h-12 sm:h-13 px-8 text-sm sm:text-base font-bold",
        xxl: "h-14 px-10 text-base font-bold",
        icon: "size-10",
      },
    },
    defaultVariants: {
  ...
  return (
    <>
      <Comp
        ...
        {...props}
      >
        {/* Subtle Specular Top Reflection (Liquid Glass Sheen) */}
        <div
          aria-hidden="true"
          className="absolute inset-x-0 top-0 h-1/2 rounded-[inherit] bg-gradient-to-b from-white/25 via-white/5 to-transparent pointer-events-none opacity-80 group-hover:opacity-100 transition-opacity duration-300"
        />

        {/* Ambient Subtle Edge Highlight */}
        <div
          aria-hidden="true"
