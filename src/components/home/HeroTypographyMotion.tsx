    ...
    <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
      ...
      <div className="space-y-3">
        ...
        <div
          ...
          className={`text-center text-base sm:text-xl md:text-2xl font-bold text-slate-700 tracking-tight transition-all leading-snug sm:leading-relaxed max-w-3xl mx-auto ${
            mounted || reducedMotion ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
