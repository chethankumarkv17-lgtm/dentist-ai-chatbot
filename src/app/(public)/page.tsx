    ...
    <div className="space-y-24 sm:space-y-32 pb-20 overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {channelCards.map((ch, idx) => {
            const Icon = ch.icon;
            return (
              <RevealOnScroll key={ch.title} variant="fade-up" delayMs={idx * 150} durationMs={600}>
                <Card className="p-6 sm:p-8 flex flex-col justify-between h-full" hoverable>
                  <div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feat, idx) => {
                ...
                return (
                  <RevealOnScroll key={feat.title} variant="fade-up" delayMs={idx * 100} durationMs={500}>
                    <div className="bg-slate-800/80 rounded-2xl p-6 border border-slate-700/80 space-y-3 hover:border-blue-500/50 transition-colors h-full">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <RevealOnScroll key={faq.q} variant="fade-up" delayMs={idx * 100} durationMs={500}>
              <Card className="p-6">
