      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <Badge variant="pro" size="sm">Live Connected</Badge>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-purple-50 text-purple-700 hover:bg-purple-100 border border-purple-200 text-xs font-bold transition-all shadow-2xs"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-green-50 text-green-700 hover:bg-green-100 border border-green-200 text-xs font-bold transition-all shadow-2xs"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-base font-bold text-slate-900">Today&apos;s Confirmed Schedule</h2>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 space-y-4">
            <h3 className="text-sm font-bold text-slate-900">Omnichannel Channels Live</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-xl border border-slate-100 bg-slate-50/60">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Website Widget</p>
                    <p className="text-[10px] text-slate-400">Embed Active</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl border border-slate-100 bg-slate-50/60">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400">Reminders Enabled</p>
                  </div>
                </div>
                <span className="w-2 h-2 rounded-full bg-emerald-500" />
              </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl border border-slate-100 bg-slate-50/60">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">AI Voice Receptionist</p>
                    <p className="text-[10px] text-slate-400">Inbound Active</p>
                  </div>
                </div>
                <span className="w-2 h-2 rounded-full bg-emerald-500" />
              </div>
            ...
            <div className="pt-2">
              <Link
                href="/widget"
                target="_blank"
                className="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-bold transition-colors"
              >
